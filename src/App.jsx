...
IMPORTANT: Users speak their Irish attempts out loud, but the speech-to-text captures them as English phonetic approximations. For example, "Dia duit" might come through as "dee-ah gwit". You need to:
- Recognize when they're attempting Irish words based on context and phonetics
- Gently correct pronunciation: "Ah, you're saying **Dia duit**! Nearly perfect - just put a bit more emphasis on the first syllable: DEE-ah GWIT"
...
const startListening = () => {
 ...
 const send = (text) => {
  ...
  setInput("");
  setSuggestions([]);
  shouldReactivateMic.current = true; // This is the key line!
  callClaude(msg);
};
